...
use GeoPHP\GeoPhp;
use Bnza\SPgSp\DBAL\Types\MultiLineStringType;
use Bnza\SPgSp\Tests\Fixtures\MultiLineStringEntity;
...
class MultiLineStringTypeTest extends AbstractGeometryTypeTest {
    ...
    {
        return ['multilinestring', MultiLineStringType::class, MultiLineStringEntity::class];
    }
